    ...
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className='text-white-400 mt-6 text-base leading-7 font-montserrat sm:max-w-sm'>Get shoes ready for the new term at your nearest Ojo store. Find Your perfect Size In Store. Get Rewards</p>
